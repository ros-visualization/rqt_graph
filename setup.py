    ...
    data_files=[
        ...
        ('share/' + package_name + '/resource/icons/rqt_icons/actions/22',
            ['resource/icons/rqt_icons/actions/22/document-open.png',
             'resource/icons/rqt_icons/actions/22/document-save-as.png',
             'resource/icons/rqt_icons/actions/22/image.png',
             'resource/icons/rqt_icons/actions/22/view-refresh.png',
             'resource/icons/rqt_icons/actions/22/zoom-original.png',
             ]),
